	...
	!! Initial guess for the eigenvectors
      ...
      ! Finalize timing
         ...
         subroutine newton_fixed_point_torus(sys, bf, tol, tol_mode)
      ...
      ! Outpost initial condition.
		...
		call logger%log_message('Exiting newton iteration.', module=this_module)
            ...
            return
         end subroutine newton_fixed_point_torus
      
         subroutine newton_forced_periodic_orbit_torus(sys, bf, tol, tol_mode)
            type(nek_system_torus_upo), intent(inout) :: sys
      !! System for which a fixed point is sought
            type(nek_dvector), intent(inout) :: bf
      !! Initial guess for the fixed point
            real(dp), intent(inout) :: tol
      ...
      ! Outpost initial condition.
		...
		call logger%log_message('Exiting newton iteration.', module=this_module)
         ...
         subroutine mflow_newton_fixed_point_torus(sys, bf, mflow_target, tol, tol_mf, tol_mode, maxiter_newton, save_part)
            type(nek_system_torus), intent(inout) :: sys
      !! System for which a fixed point is sought
            type(nek_dvector), intent(inout) :: bf
      !! Initial guess for the fixed point
            real(dp), intent(in) :: mflow_target
      ...
      !
            call newton_fixed_point_torus(sys, bf, tol, tol_mode)
      ...
      ! stamp logs
         ...
         end subroutine mflow_newton_fixed_point_torus
