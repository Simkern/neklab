      ...
      contains
         ...
         module procedure write_2d
            ...
            ! coordinates
            call nek_log_debug('   '//trim(fname)//': write x2d ...', this_module, this_procedure)
            call gather_and_write_slice(self%x2d, n2d_gown)
            call nek_log_debug('   '//trim(fname)//': write y2d ...', this_module, this_procedure)
         ...
         module procedure read_2d
            ...
            character(len=*), parameter :: this_procedure = 'read_2d'
         ...
         module procedure get_nsteps_from_header
            ! only nid 0 will read
            character(len=*), parameter :: this_procedure = 'get_nsteps_from_header'
            integer ierr, hdrsize
            real*4 test_pattern
